    ...
    render() {
        return (
            <MDBContainer>
                ...
                <MDBModal isOpen={this.props.state.modaledit} toggle={this.props.toggleAdd} fullHeight position="right">
                    <MDBModalHeader toggle={this.props.toggleAdd}>Ajouter produit</MDBModalHeader>
                    <MDBModalBody>
                    ...
                    <MDBModalFooter>
                        <MDBBtn color="danger" onClick={this.props.toggleAdd}>Fermer</MDBBtn>
                        <MDBBtn color="dark"
                        onClick={() =>
                            this.props.postfood({
